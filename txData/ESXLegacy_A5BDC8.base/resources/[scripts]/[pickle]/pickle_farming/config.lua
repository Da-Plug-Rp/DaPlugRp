...
Config.ExchangeSettings = {
    ...
    ProcessTime = 10, -- Only used when EnableSkillCheck is false.
}
...
Config.Exchange = {
    -- Processing
    {
        ...
        Catalog = {
            ["corn_raw"] = {required = 1, name = "corn", min = 1, max = 5},
            ["tomato_raw"] = {required = 1, name = "tomato", min = 1, max = 5},
            ["wheat_raw"] = {required = 1, name = "wheat", min = 1, max = 5},
            ["broccoli_raw"] = {required = 1, name = "broccoli", min = 1, max = 5},
            ["carrot_raw"] = {required = 1, name = "carrot", min = 1, max = 5},
            ["potato_raw"] = {required = 1, name = "potato", min = 1, max = 5},
            ["pickle_raw"] = {required = 1, name = "pickle", min = 1, max = 5},
        }
    },
    -- Selling
    {
        ...
        Catalog = {
            ["corn"] = {name = "money", min = 100, max = 200},
            ["tomato"] = {name = "money", min = 100, max = 200},
            ["wheat"] = {name = "money", min = 100, max = 200},
            ["broccoli"] = {name = "money", min = 100, max = 200},
            ["carrot"] = {name = "money", min = 100, max = 200},
            ["potato"] = {name = "money", min = 100, max = 200},
            ["pickle"] = {name = "money", min = 100, max = 200},
        }
    },
}
