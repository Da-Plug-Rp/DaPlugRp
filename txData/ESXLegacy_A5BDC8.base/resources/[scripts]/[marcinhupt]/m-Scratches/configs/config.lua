...
Config.Settings = {
    ...
    Core = "es_extended", -- Your core folder name "qb-core"
    Target = "qb-target", -- Your target/third eye folder name "qb-target"
    Notify = "okok", -- Change your notify here "QBCore" | "okok" | "mythic"
    Webhook = "https://discord.com/api/webhooks/1195220533982285844/yc5XpAi2zQ0D8_bKryg5K_6M0VwGPAvnAm31S8cmiiheOFpsQ78--B3Eb8N34cKzkP-Q", -- Your webhook to logs when players selling
