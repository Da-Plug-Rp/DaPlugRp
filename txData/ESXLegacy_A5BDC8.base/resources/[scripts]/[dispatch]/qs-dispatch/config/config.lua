...
Config.Framework = "esx"                                                                                                                       -- Place here the framework either esx or qb
...
Config.useVehicleIconsInDispatchLargueMap = true                                                                           -- if you set it to true the Dispatch icons for the people will be the vehicle icons instead of the player icons (Common blip map)



Config.InventorySystem = "ox_inventory" -- qb-inventory or qs-inventory or esx-default you can select ox-inventory but this is not fully tested
...
Config.Billing = 'jaksam-billing-ui'
...
Config.VehicleGarages = 'qs-garages'
