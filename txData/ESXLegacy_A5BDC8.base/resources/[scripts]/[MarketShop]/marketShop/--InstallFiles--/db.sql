...
DROP TABLE IF EXISTS `pata_marketshopstallregnoconf`;
CREATE TABLE IF NOT EXISTS `pata_marketshopstallregnoconf` (
  `id` int(11) NOT NULL,
...
--
-- Déchargement des données de la table `pata_marketshopstallregnoconf`
--

INSERT INTO `pata_marketshopstallregnoconf` (`id`, `typeOf`, `itemIn`) VALUES
(15, 'food', '[]'),
(16, 'food', '[]'),
(17, 'food', '[]'),
(18, 'food', '[]'),
...
DROP TABLE IF EXISTS `pata_marketshopstallnoconf`;
CREATE TABLE IF NOT EXISTS `pata_marketshopstallnoconf` (
  `id` int(11) NOT NULL,
...
INSERT INTO `pata_marketshopstallnoconf` (`id`, `AitemIn`, `AtypeOf`, `BitemIn`, `BtypeOf`, `CitemIn`, `CtypeOf`, `DitemIn`, `DtypeOf`) VALUES
...
DROP TABLE IF EXISTS `pata_marketshopstall`;
CREATE TABLE IF NOT EXISTS `pata_marketshopstall` (
  `id` int(11) NOT NULL,
...
INSERT INTO `pata_marketshopstall` (`id`, `color`, `sizeOf`, `AtypeOf`, `Amodel`, `AitemIn`, `BtypeOf`, `Bmodel`, `BitemIn`, `CtypeOf`, `Cmodel`, `CitemIn`, `DtypeOf`, `Dmodel`, `DitemIn`) VALUES
...
DROP TABLE IF EXISTS `pata_marketshopstock`;
CREATE TABLE IF NOT EXISTS `pata_marketshopstock` (
...
--
-- Déchargement des données de la table `pata_marketshopstock`
--
