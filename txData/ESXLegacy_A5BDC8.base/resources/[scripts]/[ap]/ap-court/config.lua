...
Config.Target = {
	['fivem-target'] = { -- Uncle Just Fivem Target Preset.
		['bar'] = {
			active = true,
			coords = {x = 244.3730, y = -1092.3707, z = 28.2943, h = 334.0080}
		},
		['court'] = {
			active = true,
			coords = {x = 242.3003, y = -1092.4473, z = 28.2943, h = 0.6681}
		},
		['juryCourt'] = {
			active = true,
			coords = vector3(258.1, -1101.54, 29.36)
		},
		['judge'] = {
			active = true,
			coords = vector3(239.75, -1096.53, 30.12),
			job = {name = Config.CourtJob, grade = 1}
		},
		['tableCourt'] = {
			active = true,
			coords = vector3(252.46, -1107.78, 30.08),
			job = {name = Config.CourtJob, grade = 1}
		}
	},
	['qtarget'] = { -- Gabz City Hall Qtarget Preset.
        ['bar'] = {
            active = true,
            ped = {model = 'a_m_y_business_02', sex = 'male'},
            coords = {x = -542.21, y = -197.04, z = 37.24, h = 78.52}
        },
        ['court'] = {
            active = true,
            ped = {model = 'a_f_y_business_02', sex = 'female'},
            coords = {x = -552.55, y = -202.86, z = 37.23, h = 343.84}
        },
        ['juryCourt'] = {
            active = true,
            boxzone = {
                name = "jury_zone_doj",
                coords = vector3(-580.93, -216.77, 38.23),
                length = 5.8,
                width = 1.1,
                heading = 30,
                debugPoly = false,
        ...
        ['judge'] = {
            ...
            boxzone = {
                name = "judge_zone_doj",
                coords = vector3(-587.04, -205.98, 38.23),
                length = 0.6,
                width = 0.4,
                heading = 300,
                debugPoly = false,
        ...
        ['tableCourt'] = {
            ...
            boxzone = {
                ...
                coords = vector3(-576.18, -209.77, 38.77),
                length = 0.6,
                width = 0.6,
                heading = 305,
                debugPoly = false,
...
Config.PhoneSettings = {
	['GCPhone'] = {
		['jury_summons'] = {
			['notify'] = "You have received a text message from the court.",
			['sender'] = "court",
			['sms'] = "Dear %s, You have been summoned to the court for jury service. Case Name: %s Time & Date %s, Please make sure you attend the court 10 minutes prior to the case start time. Thank you, San Andres District Court"
		},
		['jury_summons_remove'] = {
			['notify'] = "You have received a text message from the court.",
			['sender'] = "court",
			['sms'] = "Dear %s, You have been removed as jury from %s. Time & Date %s, You are no longer required to attend to this case. Thank you, San Andres District Court"
		},
		['court_summons'] = {
			['notify'] = "You have received a text message from the court.",
			['sender'] = "court",
			['sms'] = "This message serves as official written notice, %s is to appear in court on %s in the case of %s. If for any reason you can not make the scheduled court date, contact a court administrator a soon as possible. Failure to appear could result in legal actions taken against you. Thank you for your cooperation, San Andres District Court"
		},
		['bar_approve'] = {
			['notify'] = "You have received a text message from the court.",
			['sender'] = "court",
			['sms'] = "Dear %s, We are delighted to inform you that your background checks have passed. Your bar application is now completed, please visit the court to collect your bar license card. Kind Regards, National Bar Association"
		},
		['bar_deny'] = {
			['notify'] = "You have received a text message from the court.",
			['sender'] = "court",
			['sms'] = "Dear %s, We regret to inform you that your background checks have failed. The Reason for this is %s. Kind Regards, National Bar Association"
		},
		['bar_remove'] = {
			['notify'] = "You have received a text message from the court.",
			['sender'] = "court",
			['sms'] = "Dear %s, We regret to inform you that your bar membership has been removed. The Reason for this is %s. Kind Regards, National Bar Association"
		},
		['bar_exam_retake'] = {
			['notify'] = "You have received a text message from the court.",
			['sender'] = "court",
			['sms'] = "Dear %s, We are delighted to inform you that you can now retake the exam. Please visit the court to retake the exam. Kind Regards, National Bar Association"
		},
		['appointment_update'] = {
			['notify'] = "You have received a text message from the court.",
			['sender'] = "court",
			['sms'] = "We have received your request and scheduled you as followed. %s at the San Andres District Court House. Please arrive at least 5 minutes early to your appointment. Thank you, San Andres District Court"
		}
	},
