...
INSERT IGNORE INTO `ap_dlcsettings` (`script`, `settings`, `other`, `id_storage`) VALUES
	('ap_voting', '{"endDate":"0 days, 0 hours, and 0 minutes.","voteState":0,"funds":1000,"time":0,"currentType":0}', '{"Housing":0.2,"Income":0.15,"Vehicle":0.2,"Item":0.2,"Business":0.15}', '[]');
