...
-- Dumping structure for table es_extended.ap_appointments
...
-- Dumping data for table es_extended.ap_appointments: ~0 rows (approximately)
/*!40000 ALTER TABLE `ap_appointments` DISABLE KEYS */;
/*!40000 ALTER TABLE `ap_appointments` ENABLE KEYS */;

-- Dumping structure for table es_extended.ap_dlcsettings
...
-- Dumping data for table es_extended.ap_dlcsettings: ~0 rows (approximately)
...
-- Dumping structure for table es_extended.ap_tax
...
-- Dumping data for table es_extended.ap_tax: ~1 rows (approximately)
/*!40000 ALTER TABLE `ap_tax` DISABLE KEYS */;
/*!40000 ALTER TABLE `ap_tax` ENABLE KEYS */;

-- Dumping structure for table es_extended.ap_voting
...
-- Dumping data for table es_extended.ap_voting: ~1 rows (approximately)
