Config = {
	...
	DiscordWebhook = { -- Set the webhooks you want to use to true.
	...
	VotingSettings = {
	  Staff = {
		...
		Command = "admin-openvotingmanagement", -- Set this too what you want the command to be.
    ...
    Interactions = {fivem_target = false, qTarget = false, oxTarget = true, drawText = false}, -- Set the target system to true that you use.
	Banking = {
	...
	esx_society = true, -- Leave to true if you use esx_society resource, else set to true and change the values in server/functions.lua.
	Context = {ZF = false, NH = false, OX = true}, -- Set this to your to "ZF" or "NH" NH is only supported on version 2.
	Dialog = {ZF = false, NH = false, OX = true} -- If using ZF DIALOG then use "ZF", if using OX Keyboard then use "OX",
}
...
Config.Tax = {
  MayorControl = {
    enable = true,
	TaxTypes = {
	  ["Income"] = {enable = true, mayorControl = true, label = 'Income', percentageCap = 0.20, percentage = 0.15, AddCityHallFunds = true},		
	  ["Housing"] = {enable = false, mayorControl = false, label = 'Housing', percentageCap = 0.15, percentage = 0.15, AddCityHallFunds = true},
	  ["Vehicle"] = {enable = true, mayorControl = true, label = 'Vehicle', percentageCap = 0.15, percentage = 0.15, AddCityHallFunds = true},
	  ["Item"] = {enable = true, mayorControl = true, label = 'Item', percentageCap = 0.20, percentage = 0.15, AddCityHallFunds = true},
	}
  }
}
...
Config.BusinessTax = {
	...
	securityVerify = true, -- Set this to true if you want the player to recive a pin to verify registering a business with the mayor.
	IsBossNames = {"boss","chief", "mayor"}, -- add the player rank names that are allowed to register there company.
	tax = {
      mayorControl = {
	  ...
	  AutoStoreTime = {enable = true, timetaken = 8}, -- This will store the time that the server is up for, which means you can set the time until tax to as many minutes as you would like.
...
Config.Voting = {
	[1] = {
		enable = true,
		poll = "Mayor Election",
		givenJob = {name = "cityhall", label = "Mayor", grade = 1},
	...
	[2] = {
		...
		givenJob = {name = "police", label = "Police Chief", grade = 4},
	...
	[3] = {
		...
		givenJob = {name = "ambulance", label = "Chief Of EMS", grade = 3},
		applicationJobCheck = {enable = true, job = "ambulance", notify = "You need to be in the medical department in order to be considered as a candidate!"}
	},
	[4] = {
		enable = true,
		poll = "Judge Election",
		givenJob = {name = "court", label = "Judge", grade = 1},
		applicationJobCheck = {enable = true, job = "court", notify = "You need to be in the DOJ department in order to be considered as a candidate!"}
	},
}

Config.Target = { -- Fivem Target & QTARGET BOTH PRESETUP FOR GABZ CITY HALL.
	['fivem-target'] = {
		['votingSystem'] = {
			['votingStaff'] = {
				['active'] = true,
				['ped'] = {
					active = true,
					ped = {model = 'a_f_y_business_03', sex = 'female'},
                    coords = {x = -539.71, y = -177.15, z = 37.23, h = 225.43}
				},
				['staff'] = {
					coords = vector3(-538.3505, -177.7929, 39.3730),
			...
			['votingPoints'] = {
				['active'] = true,
                ['points'] = {
					{active = true, name = "voting_booth1", coords = vector3(-534.12, -174.51, 38.23)},
					{active = true, name = "voting_booth2", coords = vector3(-533.36, -175.84, 38.23)},
			        {active = true, name = "voting_booth3", coords = vector3(-532.59, -177.15, 38.23)},
			        {active = true, name = "voting_booth4", coords = vector3(-541.82, -182.48, 38.23)},
			        {active = true, name = "voting_booth5", coords = vector3(-542.59, -181.17, 38.23)},
			        {active = true, name = "voting_booth6", coords = vector3(-543.36, -179.84, 38.23)},
				}
			}
		},
		['majorOffice'] = {
			...
			['points'] = {
				{active = true, name = "office_one", coords = vector3(-528.64, -188.97, 43.37)},
			}
		},
		['appointmentsPed'] = {
			['active'] = true,
			['ped'] = {
				active = true,
				ped = {model = 'a_m_y_business_03', sex = 'male'},
				coords = {x = -549.9996, y = -190.8860, z = 37.2270, h = 183.8847}
			}
		}
    },
    ['qtarget'] = {
		...
		['majorOffice'] = {
			...
			['job'] = {name = "cityhall", grade = 1},
			['points'] = {
				{active = true, name = "office_one", coords = vector3(-528.64, -188.97, 43.37), length = 3, width = 1.3, heading = 30, minZ = 43.17, maxZ = 43.67, job = {name = "cityhall", grade = 1}},
			}
		},
		['appointmentsPed'] = {
			['active'] = true,
	...
	['DrawText'] = { -- Preset for Gabz Townhall
	  ['govpoints'] = {
		...
		['appointments'] = {
			...
			trigger = 'ap-government:target:appointmentData', isServer = false
		},
	  },
	  ['votingPoints'] = {
...
Config.PhoneSettings = {
	['MAIL'] = { -- USE THIS FOR GKSPHONE / QUASAR-PHONE / GCPhone / HIGH-PHONE / ROADPHONE
		['approve_candidate'] = {
			['title'] = "Mail",
		...
		['candidate_removal'] = {
			...
			['msg'] = " Email received from the government",
			['sender'] = "Government",
			['subject'] = "Removal Of Candidacy",
			['image'] = "/html/static/img/icons/mail.png",
			['mail'] = "Dear %s, <br /><br /> You are reciveing this email as you have been removed from the voting poll for the reason %s. <br /><br /> Regards,<br /><br /> City Government<br />",
			['button'] = '{"buttonEvent":"ap-voting:client:setTownhallWaypoint","buttonData":"test","buttonname":"Directions To Townhall"}',
			--HIGH PHONE ONLY BELOW 
			['email'] = "voting@gov.com",
			['photo'] = "",
		...
		['verify_player'] = {
			...
			['subject'] = "Verify Pin",
			['image'] = "/html/static/img/icons/mail.png",
			['mail'] = "Dear %s, <br /><br /> You are reciveing this email as a security check, please provide this pin to the mayor's office. PIN: %s <br /><br /> Regards,<br /><br /> Mayors Office<br />",
			['button'] = '{"buttonEvent":"ap-voting:client:setTownhallWaypoint","buttonData":"test","buttonname":"Directions To Townhall"}',
			--HIGH PHONE ONLY BELOW 
		...
		['registerd_company'] = {
			...
			['image'] = "/html/static/img/icons/mail.png",
			['mail'] = "Dear %s, <br /><br /> You are reciveing this email as your business %s has been registerd on the city database, any questions make an appointment with the mayors office. <br /><br /> Regards,<br /><br /> Mayors Office<br />",
			['button'] = '{"buttonEvent":"ap-voting:client:setTownhallWaypoint","buttonData":"test","buttonname":"Directions To Townhall"}',
			--HIGH PHONE ONLY BELOW 
		...
		['transfer_company'] = {
			...
			['image'] = "/html/static/img/icons/mail.png",
			['mail'] = "Dear %s, <br /><br /> You are reciveing this email as your business %s has been transferd to %s, any issues please make an appointment with the mayors office. <br /><br /> Regards,<br /><br /> Mayors Office<br />",
			['button'] = '{"buttonEvent":"ap-voting:client:setTownhallWaypoint","buttonData":"test","buttonname":"Directions To Townhall"}',
			--HIGH PHONE ONLY BELOW 
			['email'] = "business@gov.com",
			['photo'] = "",
		...
		['company_tax_change'] = {
			...
			['image'] = "/html/static/img/icons/mail.png",
			['mail'] = "Dear %s, <br /><br /> You are reciveing this email as your business tax has been changed from "..Config.Currency.."%s to "..Config.Currency.."%s, any issues please make an appointment with the mayors office. <br /><br /> Regards,<br /><br /> Mayors Office<br />",
			['button'] = '{"buttonEvent":"ap-voting:client:setTownhallWaypoint","buttonData":"test","buttonname":"Directions To Townhall"}',
			--HIGH PHONE ONLY BELOW 
			['email'] = "business@gov.com",
			['photo'] = "",
		...
		['message_company_owner'] = {
			...
			['subject'] = "Business",
			['image'] = "/html/static/img/icons/mail.png",
			['mail'] = "Dear %s, <br /><br /> %s <br /><br /> Regards,<br /><br /> Mayors Office<br />",
			['button'] = '{"buttonEvent":"ap-voting:client:setTownhallWaypoint","buttonData":"test","buttonname":"Directions To Townhall"}',
			--HIGH PHONE ONLY BELOW 
			['email'] = "business@gov.com",
			['photo'] = "",
		...
		['arrange_appointment'] = {
			...
			['subject'] = "Appointment",
			['image'] = "/html/static/img/icons/mail.png",
			['mail'] = "Dear %s, <br /><br /> You are receiving this email as you appointment has been scheduled for %s at the cityhall. <br /><br /> please make sure you turn up for your appointment 5 minutes before the scheduled time.<br /><br /> Regards,<br /><br /> Mayors Office<br />",
			['button'] = '{"buttonEvent":"ap-voting:client:setTownhallWaypoint","buttonData":"test","buttonname":"Directions To Townhall"}',
			--HIGH PHONE ONLY BELOW 
		...
		['company_grant'] = {
			...
			['image'] = "/html/static/img/icons/mail.png",
			['mail'] = "Dear %s, <br /><br /> You are receiving this email as your business has been given a grant of "..Config.Currency.."%s from the City Hall,  <br /><br /> Reason for grant: %s.<br /><br /> Regards,<br /><br /> Mayors Office<br />",
			['button'] = '{"buttonEvent":"ap-voting:client:setTownhallWaypoint","buttonData":"test","buttonname":"Directions To Townhall"}',
			--HIGH PHONE ONLY BELOW 
			['email'] = "grant@gov.com",
			['photo'] = "",
