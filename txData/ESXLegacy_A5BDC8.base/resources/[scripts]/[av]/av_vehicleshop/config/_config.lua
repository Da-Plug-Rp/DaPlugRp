-- Make sure to read the full docs before using this script: https://docs.av-scripts.com/guides/vehicleshop
-- Make sure to read the full docs before using this script: https://docs.av-scripts.com/guides/vehicleshop
-- Make sure to read the full docs before using this script: https://docs.av-scripts.com/guides/vehicleshop
...
Config = {
    ...
    OldTimer = true -- true/false use old timer, if you have ox_lib change it to false (client/framework.lua line 77) and uncomment the ox_lib import from fxmanifest.lua
}