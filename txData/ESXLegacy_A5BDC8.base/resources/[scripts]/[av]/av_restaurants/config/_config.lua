...
Config = Config or {}
Config.Framework = "ESX" -- QBCore or ESX... For latest ESX versions make sure to uncomment the import in fxmanifest.lua
...
Config.MultiplyValuePerIngedient = false -- true/false it will multiply the eat/drink/joint value per 1, 2 or 3 depending on how many ingredients the item have
