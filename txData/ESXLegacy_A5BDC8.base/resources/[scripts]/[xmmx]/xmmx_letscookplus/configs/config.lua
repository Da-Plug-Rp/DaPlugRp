...
Config = {
    ...
    Core = "esx", -- "qb" or "esx"
    CoreObject = 'es_extended', -- supports the latest "qb-core" or "es_extended" 
    ...
    Utils = 'ox', -- "ox" for ox_lib progress circle, or "qb" for default progressbar included with QBCore.    
    Notify = 'ox', -- "ox" for ox_lib notifications or "qb" for QBCore notifications.
