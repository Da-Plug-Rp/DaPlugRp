...
Config = {
    ...
    PoliceStations = {
        ...
        ['Rord Ford Police Department'] = {
            ...
            Duty = vector3(-318.8754, -281.5493, 35.5864), -- Duty ON / OFF coords
            DutyBlips = true, -- With this the cops can see the other cops in the map.

            Cloakrooms = {
                vector3(-338.7040, -251.3538, 32.7068),
                -- You can add more...
            },

            Armorys = {
                vector3(-337.6893, -247.2913, 34.3955),
                -- You can add more...
            },
            ...
            BossMenu = {
                grades = {4},
                coords = {
                    vector3(-311.5574, -272.5428, 39.8927),
                    -- You can add more...
                }
            },
            ...
            Garages = {
                {
                    ...
                    menu = vector3(-330.6330, -265.0475, 28.1823), -- Garage menu open coords
                    spawn = vector4(-323.6898, -265.6087, 28.0675, 143.1318), -- Vehicle spawn coords
                    deposit = vector3(-331.1636, -275.4935, 28.0675), -- Vehicle deposit place
    ...
    SpeedCameras = {
        ...
        Positions = {
            ...
            {coords = vector3(-1057.4922, -607.0911, 17.9110), job = 'police', limit = 100, price = 1500, radius = 25.0, blip = true},
