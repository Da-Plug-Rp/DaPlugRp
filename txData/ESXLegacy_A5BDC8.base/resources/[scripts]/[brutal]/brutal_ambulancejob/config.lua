...
Config = {
    ...
    NPCMedicers = {
        -- GABZ Hospital Coords
        {price = 100, time = 10, coords = vector3(318.8537, -585.8278, 43.2841), bedcoords = vector3(317.7270, -585.3508, 44.2040), bedheading = 338.0, prop = 'v_med_bed2'},
        {price = 100, time = 10, coords = vector3(5530.1235, -5223.8828, 13.7657), bedcoords = vector3(5537.45947265625,-5225.525390625,14.2667236328125), bedheading = 25.511812210083008, prop = 'v_med_bed2'},
