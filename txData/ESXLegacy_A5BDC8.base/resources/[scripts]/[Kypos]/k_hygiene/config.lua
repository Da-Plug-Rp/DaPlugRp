...
Config.Variables = {
    ...
    toiletLocations = { -- (You can also use a toilet prop)
        ...
        [3] = vector4(-1054.8572, -1434.6610, -1.4203, 103.3195),--koi employee toilet
        [4] = vector4(-1049.3650, -1489.9712, 2.7800, 314.5783),--koi female toilet
        [5] = vector4(-1047.4888, -1492.6575, 2.7800, 310.0818),--koi male toilet
    },
    ShowerLocations = { --If you have MLO's with bathrooms showers you can supply them here
        ...
        [14] = vector4(4876.2705, -4933.5498, 3.2748, 154.2812), -- cayoo island shower 1
        [15] = vector4(4881.5688, -4907.4165, 3.3856, 216.9597), -- cayoo island shower 2
        [16] = vector4(4900.5508, -4902.5732, 3.3746, 324.7197), -- cayoo island shower 3
        [17] = vector4(4921.9087, -4917.5586, 3.4380, 91.0922), -- cayoo island shower 4
        [18] = vector4(-1054.8579, -1437.3140, -1.3778, 268.4859),-- koi shower
        [19] = vector4(1771.7772, 2497.1807, 45.7408, 300.5944), -- Prison shower 
        [20] = vector4(-448.2791, 6017.5845, 27.5815, 45.5602), -- State Patrol prisoner shower
        [21] = vector4(-341.9079, -252.2946, 32.7083, 55.5606), -- Rordford police shower
        [22] = vector4(-320.2257, -281.1122, 32.0670, 281.7227), -- Rordford prisoner shower 
        [23] = vector4(1809.6659, 3682.8940, 34.1893, 350.4283), -- sandy prisoner shower 
        [24] = vector4(852.6964, -1310.4318, 28.2449, 9.7409), -- la mesa police shower 
        [25] = vector4(831.7648, -1302.3546, 28.4042, 178.4101), -- la mesa prisoner shower
        [26] = vector4(70.1059, -1393.8370, 29.7384, 3.7074), -- main clothing shower  
        [27] = vector4(295.2779, -597.9933, 43.3238, 64.9581) -- pillbox clothing shower  
    }
}
...
Config.HygieneStatus = {
    ...
    ['Poop'] = {
        hasThis = false, --Dont Touch
        canFade = false,
        iterationsUntil = 30000, -- Each iteration is 5sec (IterationsRate)
    },
    ['Pee'] = {
        hasThis = false, --Dont Touch
        canFade = false,
        iterationsUntil = 20000, -- Each iteration is 5sec (IterationsRate)
    }
}
