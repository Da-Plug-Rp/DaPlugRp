Config = {
    ...
    Text = {
        ...
        AIM_LEFT = "point left",
        AIM_RIGHT = "point right",
        AIM_SLOWER = "aim slowly",
        ...
        HINT_SETUP = 'set table',
        HINT_TAKE_CUE = 'catch stick',
        HINT_RETURN_CUE = 'let stick',
        ...
        BALL_IN_HAND_UP = 'Up',
        BALL_IN_HAND_DOWN = 'Below',
        BALL_POCKETED = '%s has been entered',
